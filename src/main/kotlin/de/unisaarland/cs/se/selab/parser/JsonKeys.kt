...
object JsonKeys {
    ...
    const val REFUELING_STATION = "refuelingStation"
    const val REFUEL_COST = "refuelCost"
    const val REFUEL_TIMES = "refuelTimes"
    const val UNLOADING_STATION = "unloadingStation"
    ...
    const val SHIP_PROPERTIES = "shipProperties"
    const val REFUELING_CAPACITY = "refuelingCapacity"
    const val REFUELING_TIME = "refuelingTime"
